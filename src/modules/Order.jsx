  ...
  <section className="order">
    <div className="container">
        ...
        <form className="order__form">
            ...
            <input className="order__input" type="text" name="tel" placeholder="Телефон"/>
            ...
            <fieldset className="order__payment">
                ...
                <label className="order__payment-label">
                    <input className="radio" type="radio" name="payment" value="cart" /> Картой
                </label>
                <label className="order__payment-label">
                    <input className="radio" type="radio" name="payment" value="cash" defaultChecked /> Наличные
                </label>
            </fieldset>
        </form>
    </div>
